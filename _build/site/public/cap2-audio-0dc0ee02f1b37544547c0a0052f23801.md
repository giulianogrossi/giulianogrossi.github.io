...
- L’intervallo di tensione totale del DAC è definito dai valori di tensione $V_{\text{min}}$ e $V_{\text{max}}$, dove ￼ è il livello di tensione più basso (di solito 0 V) e ￼ il livello più alto.
