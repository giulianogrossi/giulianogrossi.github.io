...
Un sistema quantizzatore in cui l'intervallo $[-V/2,V/2]$ è suddiviso in $l$ livelli di uguale ampiezza $V/l$ è detto `quantizzatore uniforme` e i livelli hanno dimensione:
\[
