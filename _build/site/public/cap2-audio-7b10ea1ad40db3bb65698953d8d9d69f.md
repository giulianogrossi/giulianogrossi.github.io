...
Per molti segnali deterministici inoltre l'errore è uniformemente distribuito in $\left[-\Delta/2,\Delta/2\right]$. Questo significa che la probabilità che l'errore sia compreso fra $e$ ed $e+de$ è $de/\Delta$.  L'errore

 quadratico medio è allora:
\[
\sigma_e^2=\int_{-\f{\Delta}{2}}^{\f{\Delta}{2}}e^2
\f{de}{\Delta}=\f{\Delta^2}{12}.
\]
