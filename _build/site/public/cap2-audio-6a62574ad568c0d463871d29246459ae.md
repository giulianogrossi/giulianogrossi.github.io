...
In figura si mostra un modello di convertitore A/D  Sample and Hold (S&H) è caratterizzato da un full-scale range $𝑅$. Il modello  è un elemento fondamentale nei sistemi di conversione analogico-digitale (ADC).
