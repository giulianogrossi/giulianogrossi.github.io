...
In figura si mostra un convertitore A/D è caratterizzato da un full-scale range $𝑅$. Il modello Sample and Hold (S&H) è un elemento fondamentale nei sistemi di conversione analogico-digitale (ADC).
