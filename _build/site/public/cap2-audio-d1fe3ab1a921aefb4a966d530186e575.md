...
Nella Fig. 3.9 è mostrato un istogramma degli errori di quantizzazione per 10.000 valori di ingresso compresi tra$ -1$ e$ 1$ con una dimensione del passo di$ \Delta = 0.125$. Come si può vedere, i diversi errori si verificano con frequenza approssimativamente uniforme e gli errori sono compresi, come previsto, tra $-\frac{\Delta}{2} \leq e(n) \leq \frac{\Delta}{2}$.
