...
Supponiamo di avere un segnale nel tempo continuo, ￼, definito per ogni valore reale di ￼ e che vogliamo elaborare nel nostro computer. Il processo di campionamento comporta la misurazione del valore di questa funzione in istanti di tempo specifici, ￼, indicizzati da \( n = 0,1,2,\dots \), per ottenere il segnale
