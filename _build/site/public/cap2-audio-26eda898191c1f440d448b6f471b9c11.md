...
Questi potrebbero, ad esempio, rappresentare i numeri interi da \( 0 \) a \( 2^{q} - 1 \) o da \( -2^{q - 1} \) a \( 2^{q - 1} - 1 \).

Se abbiamo a disposizione \( q \) bit, possiamo rappresentare \( 2^{q} \) valori diversi. 
