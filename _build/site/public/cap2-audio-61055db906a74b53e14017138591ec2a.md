...
Ipotizziamo che il  segnale di riferimento sia il segnale sinusoidale $A\sin(\omega t)$. La media di tale segnale è 0, poiché:

$$
\lim_{T\rightarrow \infty}\frac{\int_{-T}^{T}A \sin t\,dt}{2T}=0.
$$

La varianza o potenza del segnale $\sigma^2$ di tale segnale è invece $A^2/8$. Infatti:
