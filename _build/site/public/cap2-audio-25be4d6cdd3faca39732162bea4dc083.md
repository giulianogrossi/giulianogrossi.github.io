...
- Nella conversione unipolare, il DAC converte i segnali digitali in livelli di tensione che si trovano esclusivamente in un intervallo positivo o zero-positivo. Questo tipo di conversione è tipico in applicazioni dove l’intervallo di tensione deve essere limitato, ad esempio tra  0  e  $V_{\text{max}}$.
