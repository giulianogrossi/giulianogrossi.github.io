...
Ipotizziamo che il  segnale di riferimento sia $A\sin(t/2)$. La media di tale segnale è 0, poiché:
...
$$
\text{SQNR}=10\log_{10}\frac{A^2/8}{\Delta^2/12}=10\log_{10}\f{V^2}{\Delta^2}\f{A^2}{V^2}+10\log_{10}\f{3}{2}=20\log_{10}l\frac{A}{V}+1.76 \;\;\text{dB}.
$$
