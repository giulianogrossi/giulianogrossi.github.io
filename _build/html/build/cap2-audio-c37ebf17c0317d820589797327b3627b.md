...
Ipotizziamo che il segnale di riferimento per il calcolo della potenza sia il segnale sinusoidale $x(t)=A\sin(\omega t)$, la ccui potenza è del tutto analoga al segnale discreto $x(n)$. La media di tale segnale è 0, poiché:
