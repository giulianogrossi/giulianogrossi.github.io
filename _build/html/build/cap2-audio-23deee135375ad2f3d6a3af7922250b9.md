...
Se i segnali che prendiamo in considerazione hanno ampiezze comprese $-V/2$ tra e $V/2$, questo può essere ottenuto dividendo l'insieme $\left[-V/2,V/2\right]$ in $l$ intervalli, detti livelli, ed attribuendo ad un punto $x\in\left[-V/2,V/2\right]$ il centro del livello
