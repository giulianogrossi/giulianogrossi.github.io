...
Per molti segnali deterministici inoltre l'errore è uniformemente distribuito in $\left[-\Delta/2,\Delta/2\right]$. Questo significa che la probabilità che l'errore sia compreso fra $e$ ed $e+de$ è $de/\Delta$.  Lla potenza del rumore con $P_e$ è allora:
...
$$
\sigma^2=\lim_{T\rightarrow \infty}\frac{\int_{-T}^{T}(\f{A}{2}\sin t-0)^2\,
dt}{2T}=\lim_{T\rightarrow \infty}\ffac{\frac{A^2}{8}\int_{-T}^{T}(1+\cos 2t)\,dt}{2T}=\f{A^2}{8}.
$$
