...
dove $\text{round}(\cdot)$ indica l’arrotondamento al numero intero più vicino. Qui, ogni valore $x(n)$ viene quindi mappato sul livello $$ di ampiezza $\Delta$ nell’output $y(n)$.
