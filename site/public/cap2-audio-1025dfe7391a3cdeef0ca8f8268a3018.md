...
Questo significa che tutti i valori del segnale \( x(n) \) superiori a \(  \) vengono troncati a \( V/2 \) e, in modo simile, i valori negativi inferiori a \( -V/2 \) vengono troncati a \( -V/2 \). Ciò causa artefatti piuttosto gravi e udibili, che dovrebbero essere evitati, ove possibile.
