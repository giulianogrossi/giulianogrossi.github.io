...
Questo significa che tutti i valori del segnale \( x_n \) superiori a \( \alpha \) vengono troncati a \(  \) e, in modo simile, i valori negativi inferiori a \( -\alpha \) vengono troncati a \( -\alpha \). Ciò causa artefatti piuttosto gravi e udibili, che dovrebbero essere evitati, ove possibile.
