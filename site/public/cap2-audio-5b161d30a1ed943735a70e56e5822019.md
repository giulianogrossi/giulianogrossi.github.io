...
Ipotizziamo che il segnale di riferimento per il calcolo della potenza sia il segnale sinusoidale $x(t)=A\sin(\omega t)$, la cu. La media di tale segnale è 0, poiché:
