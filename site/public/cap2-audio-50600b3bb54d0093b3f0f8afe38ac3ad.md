...
$$\text{SNR}_{\text{dB}}\approx 6.02\, m+10.8\quad \text{} $$ 

La tabella seguente mostra il livello di miglioramento del rapporto segnale-rumore di un quantizzatore uniforme al variare del numero di bit.
