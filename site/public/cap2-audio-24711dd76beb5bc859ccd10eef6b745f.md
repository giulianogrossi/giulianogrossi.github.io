...
Il quantizzatore uniforme è il sistema di quantizzazione più comune per l'audio. La dimensione del passo, \( \Delta \), ovviamente diminuisce all'aumentare del numero di bit, \( \beta \). Il numero di bit usati per campione nell'audio è tipicamente di 16, 24 o 32 bit.
