...
Va notato che quando il segnale in ingresso è al di fuori dell'intervallo specificato da \( - \) a \( \alpha \), si verifica solitamente un fenomeno di `clipping`, un problema noto che può introdurre un errore arbitrario.
